...
function basic_load_scripts() {
	wp_enqueue_style( 'style', get_stylesheet_directory_uri() . '/dist/index.css' );
	
	wp_enqueue_script( 'custom', get_stylesheet_directory_uri() . '/dist/index.js', array(), false, true );
